...
public class RegexTrackTest {
  ...
  private static final Map<String, TrackInfo[]> PARSE_TESTS = new HashMap<String, TrackInfo[]>() {{
    put("a", new TrackInfo[]{
            new TrackInfo(0, 1, "string \"a\" case-sensitively"),
    });
    put("a.", new TrackInfo[]{
            new TrackInfo(0, 2, "each of [string \"a\" case-sensitively,any character,] in order"),
            new TrackInfo(0, 1, "string \"a\" case-sensitively"),
            new TrackInfo(1, 2, "any character"),
    });
    put("a.b", new TrackInfo[]{
            new TrackInfo(0, 3, "each of [string \"a\" case-sensitively,any character,string \"b\" case-sensitively,] in order"),
            new TrackInfo(0, 1, "string \"a\" case-sensitively"),
            new TrackInfo(1, 2, "any character"),
            new TrackInfo(2, 3, "string \"b\" case-sensitively"),
    });
    put("ab", new TrackInfo[]{
            new TrackInfo(0, 2, "string \"ab\" case-sensitively"),
    });
    put("a.b.c", new TrackInfo[]{
            new TrackInfo(0, 5, "each of [string \"a\" case-sensitively,any character,string \"b\" case-sensitively,any character,string \"c\" case-sensitively,] in order"),
            new TrackInfo(0, 1, "string \"a\" case-sensitively"),
            new TrackInfo(1, 2, "any character"),
            new TrackInfo(2, 3, "string \"b\" case-sensitively"),
            new TrackInfo(3, 4, "any character"),
            new TrackInfo(4, 5, "string \"c\" case-sensitively"),
    });
    ...
    put("(a)|b", new TrackInfo[]{
            new TrackInfo(0, 5, "any of [Submatch of string \"a\" case-sensitively,string \"b\" case-sensitively,]"),
            new TrackInfo(0, 3, "Submatch of string \"a\" case-sensitively"),
            new TrackInfo(1, 2, "string \"a\" case-sensitively"),
    ...
    put("a{2}", new TrackInfo[]{
            new TrackInfo(0, 4, "twice repetition of string \"a\" case-sensitively"),
            new TrackInfo(0, 1, "string \"a\" case-sensitively"),
            new TrackInfo(1, 4, "repeat twice"),
    });
    ...
    put("a{2,}", new TrackInfo[]{
            new TrackInfo(0, 5, "twice at least repetition of string \"a\" case-sensitively"),
            new TrackInfo(0, 1, "string \"a\" case-sensitively"),
    ...
    put("a*?", new TrackInfo[]{
            ...
            new TrackInfo(0, 1, "string \"a\" case-sensitively"),
            new TrackInfo(1, 3, "repeat any times(Perl extension: non-greedy)"),
    });
    put("a+?", new TrackInfo[]{
            new TrackInfo(0, 3, "1 or more repetition of string \"a\" case-sensitively"),
            new TrackInfo(0, 1, "string \"a\" case-sensitively"),
            new TrackInfo(1, 3, "repeat at least once(Perl extension: non-greedy)"),
    });
    put("a??", new TrackInfo[]{
            new TrackInfo(0, 3, "0 or 1 repetition of string \"a\" case-sensitively"),
            new TrackInfo(0, 1, "string \"a\" case-sensitively"),
            new TrackInfo(1, 3, "repeat zero or once(Perl extension: non-greedy)"),
    });
    put("a{2}?", new TrackInfo[]{
    ...
    put("x{9876543210", new TrackInfo[]{
            new TrackInfo(0, 12, "string \"x{9876543210\" case-sensitively"),
    });
    put("x{9876543210,", new TrackInfo[]{
    ...
    put("abc|def|ghi", new TrackInfo[]{
            new TrackInfo(0, 11, "any of [string \"abc\" case-sensitively,string \"def\" case-sensitively,string \"ghi\" case-sensitively,]"),
            new TrackInfo(0, 3, "string \"abc\" case-sensitively"),
            new TrackInfo(3, 4, "alternative"),
            new TrackInfo(4, 7, "string \"def\" case-sensitively"),
