...
public class RegexTrackTest {
    ...
    private static final Map<String, Track[]> PARSE_TESTS = new HashMap<String, Track[]>() {{
        ...
        put("a.", new Track[]{
                new Track(0, 2, "character class [literal 'a',any character,] in order"),
...
//        put("a|^", new Track[]{
//                new Track(0, 3, "any of [string \"a\" case-sensitively,line start,]"),
//                new Track(0, 1, "string \"a\" case-sensitively"),
...
//                new Track(0, 1, "string \"a\" case-sensitively"),
//                new Track(1, 2, "repeat at least once"),
//        });
//        put("a?", new Track[]{
